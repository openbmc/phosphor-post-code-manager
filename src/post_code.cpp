...
fs::path PostCode::serialize(const std::string& path)
{
    ...
    {
        phosphor::logging::log<phosphor::logging::level::ERR>("serialize, cereal::Exception");
    }
    catch (const fs::filesystem_error& e)
    {
        phosphor::logging::log<phosphor::logging::level::ERR>("serialize, fs::filesystem_error");
    }
}
...
bool PostCode::deserialize(const fs::path& path, uint16_t& index)
{
    try
    {
        if (fs::exists(path))
        {
            ...
            phosphor::logging::log<phosphor::logging::level::INFO>("deserialize, file exist");
            return true;
        }
        phosphor::logging::log<phosphor::logging::level::INFO>("deserialize, file is not exist");
        return false;
    }
    catch (cereal::Exception& e)
    {
        phosphor::logging::log<phosphor::logging::level::ERR>("deserialize, cereal::Exception");
        phosphor::logging::log<phosphor::logging::level::ERR>(e.what());
        return false;
    }
    catch (const fs::filesystem_error& e)
    {
        phosphor::logging::log<phosphor::logging::level::ERR>("deserialize, fs::filesystem_error");
        return false;
    }
...
bool PostCode::deserializePostCodes(const fs::path& path, std::vector<uint64_t> &codes)
{
    ...
    {
        phosphor::logging::log<phosphor::logging::level::ERR>("deserializePostCodes, cereal::Exception");
        return false;
    }
    catch (const fs::filesystem_error& e)
    {
        phosphor::logging::log<phosphor::logging::level::ERR>("deserializePostCodes, fs::filesystem_error");
        return false;
    }
